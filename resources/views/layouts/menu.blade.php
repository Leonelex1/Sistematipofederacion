...
<li class="treeview {{ Request::is('grados*', 'semestres*', 'seccions*', 'horarios*', 'notas*') ? 'menu-open' : '' }}">
    <a href="#"
    ...
    <ul class="treeview-menu"
        ...
        <li class="{{ Request::is('seccions*') ? 'active' : '' }}">
            <a href="{{ route('seccions.index') }}"><i class="fas fa-ad"></i>&nbsp;&nbsp;&nbsp;<span>Sección</span></a>
        </li>
...
<li class="treeview {{ Request::is('cursos*', 'materias*', 'competencias*') ? 'menu-open' : '' }}">
    ...
    <ul class="treeview-menu" style="{{ Request::is('cursos*', 'materias*', 'competencias*') ? 'display:block' : '' }}">
